...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         it('has a URL property defined and that the URL is not empty in each feed', function() {
         ...
         */
         it('has a name property defined and that the name is not empty in each feed', function() {
           for (let feed of allFeeds) {
       ...
       */
        ...
        */
        it('changes visibility when the menu icon is clicked', function() {
          ...
          const body = $('body');
          // click once to display the menu
    ...
    describe('New Feed Selection', function() {
       ...
       */
       ...
       beforeEach(function(done) {
         // Load the first feed
         loadFeed(0, function() {
           // Save the firstFeedContent in call back function of loadFeed
